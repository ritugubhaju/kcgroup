...
class TeamController extends Controller
{
    ...
    {
        $management = Team::where('view', 'management-team')->orderBy('order')->get();
        $bod = Team::where('view', 'bod')->orderBy('order')->get();
        $teams = Team::orderBy('order')->get();
        return view('backend.team.index',compact('teams','management','bod'));
    }
