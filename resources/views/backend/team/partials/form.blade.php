                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group">
                              ...
                              <select name="teamsection" id="teamsection"  class="form-control">
                                <option value="bod" @if(isset($team)) @if($team->view == 'bod') selected @endif @endif>BOD</option>
                                <option value="management-team" @if(isset($team)) @if($team->view == 'management-team') selected @endif @endif>Management Team</option>
                              </select>
                            </div>
                        </div>

                        <div class="col-sm-4" id="positioncontent" @if(isset($team->content)) style ="display: block" @else style="display: none" @endif>
                            <div class="form-group">
                               <strong>Where do you want to position at Management?</strong>&nbsp;
                              {{-- {{ Form::select('teamsection',['management-team'=>'Management Team','bod'=>'BOD'], old('view'),['class' =>'form-control'])}} --}}
                              <select name="content" class="form-control">
                                <option value="">Choose the position</option>
                                <option value="hod" @if(isset($team)) @if($team->content == 'hod') selected @endif @endif>Head of Department</option>
                                <option value="bm" @if(isset($team)) @if($team->content == 'bm') selected @endif @endif>Branch Manager</option>
                              </select>
                            </div>
                        </div>
                    </div>
