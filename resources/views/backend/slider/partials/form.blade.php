            ...
            <div class="card-underline">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                        <div class="form-group">
                                <label for="" class="col-form-label pt-0">Order</label>
                                    <div class="">
                                        <input class="form-control" type="number" required name="order" value="{{ old('order', isset($slider->order) ? $slider->order : '') }}" placeholder="Enter Order">
                                    </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                                <label for="" class="col-form-label pt-0">Link Caption</label>
                                    <div class="">
                                        <input class="form-control" type="text" required name="link_caption" value="{{ old('link_caption', isset($slider->link_caption) ? $slider->link_caption : '') }}" placeholder="Enter Link Caption">
                                    </div>
                         </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <select name="type" class="form-control" required id="type" >
                                     ...
                                     <option {{ $slider->type == 'Image' ? 'selected':'' }}>Image</option>
                                     <option {{ $slider->type == 'Video' ? 'selected':'' }}>Video</option>
                                </select>
